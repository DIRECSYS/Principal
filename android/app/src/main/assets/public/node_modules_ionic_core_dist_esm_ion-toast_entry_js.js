...
/* harmony import */ var _hardware_back_button_36f7543b_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./hardware-back-button-36f7543b.js */ 10348);
...
const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
  ...
  const gesture = (0,_index_2cf77112_js__WEBPACK_IMPORTED_MODULE_11__.createGesture)({
    ...
    gesturePriority: _overlays_d99a4d6a_js__WEBPACK_IMPORTED_MODULE_6__.O,
    /**
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidDismiss", 7);
    ...
    this.createSwipeGesture = toastPosition => {
      const gesture = this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
         ...
         */
        this.dismiss(undefined, _overlays_d99a4d6a_js__WEBPACK_IMPORTED_MODULE_6__.G);
      });
      gesture.enable(true);
    };
    /**
    ...
    this.duration = _ionic_global_c836c8c6_js__WEBPACK_IMPORTED_MODULE_8__.c.getNumber('toastDuration', 0);
  ...
  present() {
    ...
    return (0,F_Cursos_Ionic_Principal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animationPosition = getAnimationPosition(position, anchor, (0,_ionic_global_c836c8c6_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this), el);
      /**
      ...
      yield (0,_overlays_d99a4d6a_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
        position,
  ...
  dismiss(data, role) {
    ...
    return (0,F_Cursos_Ionic_Principal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_d99a4d6a_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation,
      /**
   ...
   */
  onDidDismiss() {
    return (0,_overlays_d99a4d6a_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_d99a4d6a_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  callButtonHandler(button) {
    return (0,F_Cursos_Ionic_Principal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_d99a4d6a_js__WEBPACK_IMPORTED_MODULE_6__.s)(button.handler);
          if (rtn === false) {
  ...
  renderButtons(buttons, side) {
    ...
    }, buttons.map(b => (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }, b.icon && (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      "aria-hidden": "true",
      icon: b.icon,
      slot: b.text === undefined ? 'icon-only' : undefined,
      class: "toast-button-icon"
    }), b.text), mode === 'md' && (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
  ...
  render() {
    ...
    return (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      class: "toast-icon",
      part: "icon",
      icon: this.icon,
      lazy: false,
...
const buttonPart = button => {
  return (0,_overlays_d99a4d6a_js__WEBPACK_IMPORTED_MODULE_6__.i)(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
