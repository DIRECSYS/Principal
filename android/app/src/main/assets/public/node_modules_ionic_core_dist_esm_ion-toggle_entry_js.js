...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.setupGesture = /*#__PURE__*/(0,F_Cursos_Ionic_Principal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_c836c8c6_js__WEBPACK_IMPORTED_MODULE_9__.c.get('toggleOnOffLabels');
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderToggle() {
    ...
    }, this.inheritedAttributes)), (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': !this.hasLabel
      },
      part: "label"
    }, (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", null)), (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new toggle syntax.`, this.el);
    ...
    }, this.renderToggleControl(), (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
    }, labelText), (0,_index_eab5468b_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
      type: "checkbox",
      role: "switch",
      "aria-checked": `${checked}`,
      disabled: disabled,
